...
Learn how to make clock with HTML, CSS and Javascript
## HTML and Javascript
```html
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container">
        <div class="clock-container">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 226.6 233.8" fill="#fff">
...
```
## Output
![Clock Output](https://cdn.hashnode.com/res/hashnode/image/upload/v1632638555760/wnR21XhRz.gif)
